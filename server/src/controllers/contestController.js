...
module.exports.getContestById = async (req, res, next) => {
	try {
		...
		if (req.tokenData.role === CONSTANTS.CUSTOMER) {
			if (contestInfo.status === 'finished') {
				contestInfo.Offers = contestInfo.Offers.filter(offer => offer.status === 'won');
			}else if(contestInfo.status === 'active')
			contestInfo.Offers = contestInfo.Offers.filter(offer => offer.status === 'verified')
		}
